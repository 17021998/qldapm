...
object DialogUtils {
    ...
    private fun showNoInternetConnection(activity: FragmentManager) {
        AlertDialogFragment.Builder(R.layout.dialog_confirm)
                ...
                .addTextView(R.id.tv_ok,MyApplication.instance.getString(R.string.Text_Confirm__TryAgain))
                .addTextView(R.id.tv_cancel,MyApplication.instance.getString(R.string.Text_Confirm__Cancel))
